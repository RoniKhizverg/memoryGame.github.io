...
if (!localStorage.getItem('player1GamesWin')) {

    let gamesWinPlayer1 = 0;
    localStorage.setItem('player1GamesWin', gamesWinPlayer1);

}
if (!localStorage.getItem('player2GamesWin')) {
    let gamesWinPlayer2 = 0
    localStorage.setItem('player2GamesWin', gamesWinPlayer2);
...
players = { // json'
    p1: {
        name: first,
        gameWin: parseInt(localStorage.getItem('player1GamesWin')),
        score: 0
    },

    p2: {
        name: second,
        gameWin: parseInt(localStorage.getItem('player2GamesWin')),
        score: 0
    }
}

localStorage.setItem('player1Name', JSON.stringify(players.p1.name));
localStorage.setItem('player2Name', JSON.stringify(players.p2.name));
...
window.addEventListener('load', () => {
    ...
    localStorage.removeItem('player1GamesWin');
    localStorage.removeItem('player2GamesWin');
...
function update() {
    ...
    localStorage.setItem('player1GamesWin', players.p1.gameWin);

    localStorage.setItem('player2GamesWin', players.p2.gameWin);
    document.getElementById('p1').innerHTML = ` ${players.p1.name}'s num of wins: ${players.p1.gameWin} score:${players.p1.score}`;
    document.getElementById('p2').innerHTML = ` ${players.p2.name}'s num of wins: ${players.p2.gameWin} score:${players.p2.score}`;
}
